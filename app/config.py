...
WAVELET_CONFIG = {
    ...
    "mode":    "periodization",  # pywt mode: tránh boundary artifacts
}
...
# ── vnstock data source ───────────────────────────────────────────────────────
# vnstock v3.x: Quote(symbol=TICKER, source=SOURCE).history(start, end, interval)
VNSTOCK_SOURCE   = "TCBS"    # HOSE data
